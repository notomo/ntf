...
M.transform_id = vim.fn.sha256(table.concat({ source_of(M.transform), source_of(statements), version.runtime() }))
...
function M.chunk(path)
  ...
  local suffix = MARKER .. vim.fn.sha256(src) .. ":" .. M.transform_id
