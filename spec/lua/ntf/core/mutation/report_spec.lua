...
describe("ntf.core.mutation.report.summary", function()
  it("scores the detected mutants and lists the undetected ones", function()
    local summary = {
      records = {
        record("/root/lua/a.lua", 1, "killed"),
        record("/root/lua/a.lua", 2, "timeout"),
        record("/root/lua/a.lua", 3, "survived"),
        record("/root/lua/b.lua", 4, "no_coverage"),
      },
  ...
  it("shows a path relative to the working directory, however that was spelled", function()
    local summary = {
      records = { record("/root/lua/a.lua", 1, "survived"), record("/other/b.lua", 2, "survived") },
